    ...
    <div className="text-center shadow  p-2 container-fluid">
      ...
      <div className="contact-info">
        ...
        <p><EmailIcon fontSize='medium'/>  Email Id</p>
          <h2 onClick={handleSendMail}>rushimorerm009@gmail.com</h2 >
        ...
        <div className="contact-item m-2">
        {/* <p><AddIcCallIcon fontSize='medium'/> contact</p> */}
          {/* <h2>9623091147</h2> */}
        ...
        >   
          <div className="contact-item m-2" >
            <h2>
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-file-pdf" viewBox="0 0 16 16">
